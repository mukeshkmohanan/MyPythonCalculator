...
btnAddition=Button(calc,padx=15,pady=16,bd=8,fg="black",bg="powder blue",command=lambda:btnClck("+"),font=('arial',20,'bold'),text="+").grid(row=1,column=3)
#==================================================================================================================================================================
...
btnSubtract=Button(calc,padx=17,pady=16,bd=8,fg="black",bg="powder blue",command=lambda:btnClck("-"),font=('arial',20,'bold'),text="-").grid(row=2,column=3)
#==================================================================================================================================================================
...
btnMultiplication=Button(calc,padx=15,pady=16,bd=8,fg="black",bg="powder blue",command=lambda:btnClck("*"),font=('arial',20,'bold'),text="*").grid(row=3,column=3)
#==================================================================================================================================================================
